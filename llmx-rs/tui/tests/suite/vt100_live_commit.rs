...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match llmx_tui::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = llmx_tui::live_wrap::RowBuilder::new(20);
    ...
    llmx_tui::insert_history::insert_history_lines(&mut term, lines)
